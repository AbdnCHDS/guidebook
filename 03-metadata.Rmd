...
To encourage creation of high quality project and object level metadata, ACHDS has created a template for you to use throughout your project from inception to conclusion.  The university's Data Librarian, Claire Bell, is available to help you as you work through this.  Once complete the librarian will take the free text entries and add controlled vocabularies and coding to the document and generate both a human readable 'Readme' file and a machine readable file. These two documents should accompany your data set in the repository of your choice and provide a helpful information to other researchers learning from your project or considering re-using your data.
