...
# Metadata and data documentation {#metadata}
...
In this context we are talking about information which provides detail both about a project and its aims, coverage and methodology, as well as object level information such as the file format of the resulting output of the project.  To ease communication within ACDHS the following two terms are used to discuss the overarching information given about a research project:

###  Project Level Documentation
This is the administrative information about a project. The Project Level documentation is algined with Dublin Core 15 core elements things    Is Machine readable
...
needs Human readable but can be made machine friendlier by using controlled vocubalury for value column headings
...
Add examples for controlled Vocabulary
